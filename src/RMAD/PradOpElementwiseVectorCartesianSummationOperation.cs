//------------------------------------------------------------------------------
// <copyright file="PradOpElementwiseVectorCartesianSummationOperation.cs" author="ameritusweb" date="5/2/2023">
...
namespace PradOpExample.RMAD
{
    ...
    /// </summary>
    public class PradOpElementwiseVectorCartesianSummationOperation : Operation
    {
        ...
        {
            return new PradOpElementwiseVectorCartesianSummationOperation();
        }
        ...
        public Matrix Forward(Matrix input1, Matrix input2, Matrix weights)
        {
            ...
            var res = vectorTools.CartesianSummationOperation(this.input1, this.input2, this.weights);
