namespace PradOpExample
{
    ...
    {
        private const string NAMESPACE = "PradOpExample.Architecture";
        ...
        public VectorFieldNetwork(int numLayers, int numNodes, int numFeatures, double learningRate, double clipValue)
        {
            ...
            var inputLayerBuilder = new ModelLayerBuilder(this)
                ...
                .AddModelElementGroup("WeightVectors", new[] { numInputOutputFeatures / 2, numInputOutputFeatures }, InitializationType.Xavier)
                .AddModelElementGroup("WeightVectors2", new[] { numInputOutputFeatures / 2, numInputOutputFeatures }, InitializationType.Xavier)
        ...
        public void InitializeState()
        {
            ...
            var input = new Matrix(CommonMatrixUtils.InitializeZeroMatrix(this.NumNodes, this.NumFeatures / 20).ToArray());
